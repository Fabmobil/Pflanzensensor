...
// Feature-Flags
#define USE_DS18B20                                                                                \
  true               // DS18B20 Temperatursensor. Mehrere können an einem PIN angeschlossen werden
...
#define DEBUG_MEASUREMENT_CYCLE true /* Debugausgaben für Messzyklus aktivieren */
...
#define MEASUREMENT_MINIMUM_DELAY 100 // minimale Verzögerung zwischen Messungen in Millisekunden
...
#define LOG_ENTRIES_TO_DISPLAY 20         /* Anzahl Log-Einträge auf der Weboberfläche anzeigen */
...
#define INFLUXDB2_TOKEN                                                                            \
  "your_token"                            /* Authentifizierungs-Token für InfluxDB v2 \
                */
#define INFLUXDB2_ORG "your_organisation" /* Organisation für InfluxDB v2 */
#define INFLUXDB2_BUCKET "your_bucket"    /* Bucket für InfluxDB v2 */

// Sensoreinstellungen
#define SENSOR_MAX_MEASUREMENTS 8      /* Maximale Anzahl Messungen pro Sensortyp */
#define SENSOR_AUTO_DEINITIALIZE false /* Sensoren nach jeder Messung deinitialisieren */
...
#define SERIAL_RECEIVER_MEASUREMENT_INTERVAL 60 // Messintervall in Sekunden
...
#define DHT_TEMPERATURE_MIN -40.0f             /* Minimaler gültiger Temperaturwert in °C */
#define DHT_TEMPERATURE_MAX 80.0f              /* Maximaler gültiger Temperaturwert in °C */
...
#define DS18B20_MINIMUM_DELAY 750       // minimale Zeit zwischen Messungen in Millisekunden
...
#define DS18B20_1_MEASUREMENT_INTERVAL DS18B20_MEASUREMENT_INTERVAL // Messintervall
...
#define DS18B20_2_MEASUREMENT_INTERVAL DS18B20_MEASUREMENT_INTERVAL // Messintervall
...
#define DS18B20_3_MEASUREMENT_INTERVAL DS18B20_MEASUREMENT_INTERVAL // Messintervall
...
#define DS18B20_4_MEASUREMENT_INTERVAL DS18B20_MEASUREMENT_INTERVAL // Messintervall
...
#define DS18B20_5_MEASUREMENT_INTERVAL DS18B20_MEASUREMENT_INTERVAL // Messintervall
...
#define DS18B20_6_MEASUREMENT_INTERVAL DS18B20_MEASUREMENT_INTERVAL // Messintervall
...
#define DS18B20_7_MEASUREMENT_INTERVAL DS18B20_MEASUREMENT_INTERVAL // Messintervall
...
#define DS18B20_8_MEASUREMENT_INTERVAL DS18B20_MEASUREMENT_INTERVAL // Messintervall
...
#define SDS011_WARMUP_TIME 35 * 1000               // milliseconds of warumup time for SDS011 sensor
...
#define ANALOG_MEASUREMENT_INTERVAL MEASUREMENT_INTERVAL // measurement interval
#define ANALOG_MINIMUM_DELAY 100       // minimum delay between measurements in milliseconds
...
#define ANALOG_1_CALIBRATION_MODE ANALOG_CALIBRATION_MODE // activate autocalibration
#define ANALOG_1_INVERTED false                 // invert scale (true = inverted, false = normal)
...
#define ANALOG_2_CALIBRATION_MODE ANALOG_CALIBRATION_MODE // activate autocalibration
#define ANALOG_2_INVERTED false                 // invert scale (true = inverted, false = normal)
...
#define ANALOG_3_CALIBRATION_MODE ANALOG_CALIBRATION_MODE // activate autocalibration
#define ANALOG_3_INVERTED false                 // invert scale (true = inverted, false = normal)
...
#define ANALOG_4_CALIBRATION_MODE ANALOG_CALIBRATION_MODE // activate autocalibration
#define ANALOG_4_INVERTED false                 // invert scale (true = inverted, false = normal)
...
#define ANALOG_5_CALIBRATION_MODE ANALOG_CALIBRATION_MODE // activate autocalibration
#define ANALOG_5_INVERTED false                 // invert scale (true = inverted, false = normal)
...
#define ANALOG_6_CALIBRATION_MODE ANALOG_CALIBRATION_MODE // activate autocalibration
#define ANALOG_6_INVERTED false                 // invert scale (true = inverted, false = normal)
...
#define ANALOG_7_CALIBRATION_MODE ANALOG_CALIBRATION_MODE // activate autocalibration
#define ANALOG_7_INVERTED false                 // invert scale (true = inverted, false = normal)
...
#define ANALOG_8_CALIBRATION_MODE ANALOG_CALIBRATION_MODE // activate autocalibration
#define ANALOG_8_INVERTED false                 // invert scale (true = inverted, false = normal)
