...
ConfigWebHandler::ConfigWebHandler(ConfigManager& configManager)
    : m_configManager(configManager) {}

ConfigWebHandler::WebResult ConfigWebHandler::updateFromWebRequest(
...
ConfigWebHandler::WebResult ConfigWebHandler::processBooleanSettings(
    ESP8266WebServer& server, bool& configChanged) {
