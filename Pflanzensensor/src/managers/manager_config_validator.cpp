...
ConfigValidator::ValidationResult ConfigValidator::validatePassword(
...
ConfigValidator::ValidationResult ConfigValidator::validateLogLevel(
    const String& level) {
...
ConfigValidator::ValidationResult ConfigValidator::validateConfigData(
