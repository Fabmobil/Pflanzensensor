...
struct SerialReceiverConfig : public SensorConfig {
  ...
  SerialReceiverConfig() : baudRate(9600), timeout(4000), requestCommand("GET") {}
...
public:
  ...
  SharedHardwareInfo getSharedHardwareInfo() const override {
    ...
    return SharedHardwareInfo(SensorType::SERIAL_RECEIVER, SERIAL_RECEIVER_RX_PIN,
                              config_.minimumDelay);
#else
   ...
   */
  size_t getNumMeasurements() const override { return config_.activeMeasurements; }
