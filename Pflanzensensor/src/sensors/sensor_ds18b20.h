...
struct DS18B20Config : public SensorConfig {
   ...
   */
  DS18B20Config() : oneWireBus(ONE_WIRE_BUS), sensorCount(DS18B20_SENSOR_COUNT) {
    name = F("DS18B20");
...
public:
   ...
   */
  explicit DS18B20Sensor(const DS18B20Config& config, class SensorManager* sensorManager);
...
private:
  ...
  // Helper methods
  const DS18B20Config& ds18b20Config() const { return static_cast<const DS18B20Config&>(config()); }
