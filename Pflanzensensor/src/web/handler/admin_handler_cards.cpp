...
void AdminHandler::generateAndSendMailSettingsCard() {
  ...
  // Mail enabled
  sendChunk(F("<div class='form-group'><label class='checkbox-label'>"));
  sendChunk(F("<input type='checkbox' id='mail_enabled' "
  ...
  sendChunk(F("<input type='text' id='smtp_host' name='smtp_host' value='"));
  ...
  sendChunk(F("<input type='number' id='smtp_port' name='smtp_port' value='"));
  ...
  sendChunk(F("<input type='email' id='smtp_user' name='smtp_user' value='"));
  ...
  sendChunk(F("<input type='password' id='smtp_password' name='smtp_password' value='"));
  ...
  sendChunk(F("<input type='text' id='smtp_sender_name' name='smtp_sender_name' value='"));
  ...
  sendChunk(F("<input type='email' id='smtp_sender_email' name='smtp_sender_email' value='"));
  ...
  sendChunk(F("<input type='email' id='smtp_recipient' name='smtp_recipient' value='"));
  ...
  // SMTP STARTTLS
  sendChunk(F("<div class='form-group'><label class='checkbox-label'>"));
  sendChunk(F("<input type='checkbox' id='smtp_enable_starttls' "
              "name='smtp_enable_starttls' value='true'"));
  if (ConfigMgr.isSmtpEnableStartTLS())
    sendChunk(F(" checked"));
  sendChunk(F("> STARTTLS-Verschlüsselung aktivieren</label></div>"));

  // SMTP Debug
  sendChunk(F("<div class='form-group'><label class='checkbox-label'>"));
  sendChunk(F("<input type='checkbox' id='smtp_debug' "
  ...
  sendChunk(F("<div class='form-group'><label class='checkbox-label'>"));
  sendChunk(F("<input type='checkbox' id='smtp_send_test_mail_on_boot' "
  ...
  if (ConfigMgr.isMailEnabled()) {
    sendChunk(F("<form action='/admin/testMail' method='POST' "
                "style='margin-top:8px;'>"));
    sendChunk(F("<button type='submit' class='button button-secondary'>Test-Mail "
                "senden</button>"));
    sendChunk(F("</form>"));
  }
