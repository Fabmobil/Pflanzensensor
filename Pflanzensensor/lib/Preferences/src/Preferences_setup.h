...
// Custom configuration for Pflanzensensor
// Force EEPROM backend instead of LittleFS to survive filesystem OTA updates

#if defined(NVS_USE_EEPROM)
  // Use our custom EEPROM implementation
  #define NVS_USE_CUSTOM_EEPROM
#elif defined(NVS_USE_POSIX) || defined(NVS_USE_LITTLEFS) || defined(NVS_USE_SPIFFS) || defined(NVS_USE_WIFININA) || defined(NVS_USE_DCT)
  // OK, use it.
