...
void setup() {
  Serial.begin(
      115200); // serielle Kommunikation mit einer Geschwindigkeit von 115200 Bits pro Sekunde initialisieren
}

void loop() {
  int sensorwert = analogRead(
      sensor); // Wert des Sensors an Analogping A0 auslesen und in der Variable "sensorWert" speichern
